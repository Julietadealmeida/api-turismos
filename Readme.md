...
##**sem hospedagem**
-**pontos**
GET http://localhost/api_turismo/pontos/listar.php → Lista os pontos turísticos
POST http://localhost/api_turismo/pontos/cadastrar.php → Cadastra um novo ponto
GET http://localhost/api_turismo/pontos/editar.php?id=1 → Busca ponto para editar
DELETE http://localhost/api_turismo/pontos/excluir.php?id=1 → Exclui um ponto
http://localhost/api_turismo/pontos/detalhes.php?id=1-> Detalhes do ponto


-**categorias**
GET http://localhost/api_turismo/categorias/listar.php → Lista categorias
POST http://localhost/api_turismo/categorias/cadastrar.php → Cadastra uma nova categoria
GET http://localhost/api_turismo/categorias/editar.php?id=1 → Busca categoria para editar
DELETE http://localhost/api_turismo/categorias/excluir.php?id=1 → Exclui um categoria

-**cidades**
GET http://localhost/api_turismo/cidades/listar.php → Lista cidades
POST http://localhost/api_turismo/cidades/cadastrar.php → Cadastra uma nova cidade
GET http://localhost/api_turismo/cidades/editar.php?id=1 → Busca cidade para editar
DELETE http://localhost/api_turismoi/cidades/excluir.php?id=1 → Exclui uma cidade
